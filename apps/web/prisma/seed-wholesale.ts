...
const PRODUCTS: ProductSeed[] = [
  ...
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Onions',         description: 'Nashik-grade, firm pink. Wholesale-priced.', priceInr: 35, mrpInr: 35, unit: '1 kg',  isRegulated: false, accent: 'terracotta', glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Potatoes',       description: 'UP new-crop, smooth-skinned.',               priceInr: 28, mrpInr: 28, unit: '1 kg',  isRegulated: false, accent: 'forest',     glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Tomatoes',       description: 'Local hybrid, curry-grade. Picked today.',   priceInr: 24, mrpInr: 24, unit: '1 kg',  isRegulated: false, accent: 'terracotta', glyph: 'leaf', imageUrl: IMG(null) },
  ...
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Coriander',      description: 'Bundle, washed and trimmed.',                priceInr: 18, mrpInr: 18, unit: '100g',  isRegulated: false, accent: 'forest',     glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Baby Spinach',   description: 'Washed + ready to cook.',                     priceInr: 48, mrpInr: 48, unit: '250g',  isRegulated: false, accent: 'forest',     glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Capsicum',       description: 'Green bell pepper, glossy skin.',             priceInr: 55, mrpInr: 55, unit: '500g',  isRegulated: false, accent: 'forest',     glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Lemons',         description: 'Juicy, thin-skinned.',                        priceInr: 32, mrpInr: 32, unit: '500g',  isRegulated: false, accent: 'saffron',    glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Bananas',        description: 'Robusta, table-ripe.',                        priceInr: 58, mrpInr: 58, unit: '1 dozen', isRegulated: false, accent: 'saffron',   glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Apples',         description: 'Shimla-Royal-Delicious.',                     priceInr: 165, mrpInr: 165, unit: '1 kg', isRegulated: false, accent: 'terracotta', glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Watermelon',     description: 'Whole, ~3 kg. Knife-test cut on request.',    priceInr: 95, mrpInr: 95, unit: '1 whole', isRegulated: false, accent: 'forest',   glyph: 'leaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-mandi', category: 'produce', name: 'Pomegranate',    description: 'Maharashtra-Bhagwa, sweet seed.',             priceInr: 145, mrpInr: 145, unit: '1 kg', isRegulated: false, accent: 'terracotta', glyph: 'leaf', imageUrl: IMG(null) },

  // ───── Magarpatta Daily · Eggs ─────
  { vendor: 'magarpatta-daily', category: 'dairy', name: 'Brown Eggs (Tray)',      description: 'Free-range, refrigerated. Tray of 30.', priceInr: 285, mrpInr: 285, unit: '30 pcs', isRegulated: false, accent: 'terracotta', glyph: 'drop', isVeg: false, imageUrl: IMG(null) },
  { vendor: 'magarpatta-daily', category: 'dairy', name: 'White Eggs (Half-dozen)', description: 'Standard-grade, refrigerated.',         priceInr: 60,  mrpInr: 60,  unit: '6 pcs',  isRegulated: false, accent: 'forest',     glyph: 'drop', isVeg: false, imageUrl: IMG(null) },
  ...
  { vendor: 'magarpatta-daily', category: 'bakery', name: 'Whole-Wheat Bread Loaf', description: 'Baked at 4 AM. No preservatives.',     priceInr: 55, mrpInr: 55, unit: '400g', isRegulated: false, accent: 'saffron', glyph: 'loaf', imageUrl: IMG(null) },
  { vendor: 'magarpatta-daily', category: 'bakery', name: 'Pav (Bread Rolls)',      description: 'Soft Mumbai-style pav. Pack of 8.',     priceInr: 40, mrpInr: 40, unit: '8 pcs',  isRegulated: false, accent: 'saffron', glyph: 'loaf', imageUrl: IMG(null) },
