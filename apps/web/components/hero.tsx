      ...
      <div className="relative mx-auto max-w-[1280px] px-6 lg:px-10">
        <div className="grid lg:grid-cols-[1.15fr_1fr] gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            <h1 className="mt-7 font-display text-[52px] sm:text-[68px] lg:text-[84px] leading-[0.96] tracking-[-0.02em] text-[color:var(--color-foreground)]">
              Daily delights,
              <br />
              <span className="italic text-[color:var(--color-primary)]">delivered within</span>
              <br />
              your township.
            </h1>

            <p className="mt-6 max-w-xl text-[16px] lg:text-[17px] leading-[1.55] text-[color:var(--color-muted)]">
            ...
            <div className="mt-8 lg:mt-10">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3">
                <Link
                  href="/menu"
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full text-[13px] font-medium bg-[color:var(--color-primary)] text-[color:var(--color-background)] hover:bg-[color:var(--color-primary)] transition-colors"
                >
                  Browse the menu
                ...
                <Link
                  href="/signup"
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full text-[13px] font-medium border border-[color:var(--color-foreground)]/12 bg-[color:var(--color-surface)] text-[color:var(--color-foreground)] hover:border-[color:var(--color-primary)]/40 transition-colors"
                >
                  Create an account
                </Link>
                <span className="text-[12px] text-[color:var(--color-muted)]/70">{SOCIETY_COUNT} societies mapped</span>
              </div>
              <p className="mt-4 text-[12.5px] text-[color:var(--color-muted)]/70 max-w-xl">
                We deliver <span className="font-medium text-[color:var(--color-foreground)]">only</span>{' '}
        ...
        {/* Stats strip */}
        <div className="mt-16 lg:mt-20 grid grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-10 pt-8 border-t border-[color:var(--color-foreground)]/10">
          {[
