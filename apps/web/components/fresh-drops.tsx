      ...
      <div className="mx-auto max-w-[1280px] px-6 lg:px-10">
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-12 lg:gap-20 items-start">
          <div>
            ...
            <h2 className="mt-4 font-display text-[44px] lg:text-[56px] leading-[0.98] tracking-[-0.02em]">
              What&apos;s <span className="italic text-[color:var(--color-primary)]">out of the kadhai</span>, right now.
            </h2>
            <p className="mt-6 text-[15px] leading-[1.6] text-[color:var(--color-muted)] max-w-md">
            ...
            <div className="mt-8 inline-flex items-center gap-2 text-[12px] uppercase tracking-[0.14em] text-[color:var(--color-muted)]/80">
          ...
          <div className="relative">
            <div className="rounded-3xl border border-[color:var(--color-foreground)]/10 bg-[color:var(--color-surface)] shadow-[0_24px_60px_-28px_rgba(15,15,14,0.2)] overflow-hidden">
              <div className="flex items-center justify-between px-6 py-4 border-b border-[color:var(--color-foreground)]/8 bg-[color:var(--color-background)]/50">
                <div className="flex items-center gap-2">
                  <div className="flex gap-1.5">
                    ...
                    <span className="h-2.5 w-2.5 rounded-full bg-[color:var(--color-primary)]/50" />
                  </div>
                  <span className="ml-3 text-[11px] uppercase tracking-[0.14em] text-[color:var(--color-muted)]/70">
                    Live feed
                  </span>
                </div>
                <span className="text-[11px] text-[color:var(--color-muted)]/60">Auto-refresh · 10s</span>
              </div>
              ...
              <ul>
                {DROPS.map((d, i) => (
                  <li
                    key={`${d.where}-${i}`}
                    className="flex items-start gap-4 px-6 py-4 border-b last:border-b-0 border-[color:var(--color-foreground)]/6 hover:bg-[color:var(--color-background)]/40 transition-colors"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-baseline justify-between gap-3">
                        <p className="font-display text-[20px] leading-tight text-[color:var(--color-foreground)] truncate">
                          {d.what}
                        </p>
                      ...
                      <p className="mt-1 text-[13px] text-[color:var(--color-muted)]">
                        from <span className="text-[color:var(--color-primary)]">{d.where}</span>
                      </p>
                    </div>
                    <button className="shrink-0 mt-1.5 text-[12px] font-medium text-[color:var(--color-primary)] hover:underline underline-offset-4">
                      Add to cart
                    </button>
                  </li>
                ))}
