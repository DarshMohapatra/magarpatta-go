    ...
    <div>
      ...
      <div className="mt-6 grid sm:grid-cols-[1fr_1.6fr] gap-5">
        <div className="rounded-2xl border border-[color:var(--color-primary)]/25 bg-gradient-to-br from-[color:var(--color-primary)]/8 to-[color:var(--color-moss)]/4 p-6">
          <div className="text-[10.5px] uppercase tracking-[0.16em] text-[color:var(--color-muted)]/70">Avg food rating</div>
                ...
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 text-[11px] uppercase tracking-[0.12em]">
                      ...
                      <span className="text-[color:var(--color-muted)]/60">· order #{f.order.id.slice(-6)}</span>
                    </div>
                    ...
                    {f.foodComment && (
                      <p className="mt-2 text-[13px] leading-[1.55] text-[color:var(--color-foreground)]">&ldquo;{f.foodComment}&rdquo;</p>
                    )}
                  </div>
