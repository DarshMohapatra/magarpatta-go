...
export function ArticleEditor({ initial }: { initial: ArticleDraft }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-8">
      <div>
        <Link href="/admin/kb" className="text-[12px] text-[color:var(--color-muted)] hover:text-[color:var(--color-foreground)]">← Articles</Link>
        ...
        <input
          ...
          className="mt-3 w-full bg-transparent border-0 border-b border-[color:var(--color-foreground)]/14 focus:border-[color:var(--color-primary)] outline-none font-display text-[28px] lg:text-[36px] leading-[1.1] tracking-[-0.01em] py-2"
        />
        ...
        <textarea
          ...
          className="mt-6 w-full bg-[color:var(--color-surface)] border border-[color:var(--color-foreground)]/10 rounded-2xl px-4 py-4 text-[14px] leading-[1.6] outline-none focus:border-[color:var(--color-primary)] resize-y font-mono"
        />
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-full bg-[color:var(--color-primary)] text-[color:var(--color-background)] text-[12.5px] font-medium hover:bg-[color:var(--color-primary)] transition-colors disabled:opacity-50"
