              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="text-right shrink-0 text-[11px] uppercase tracking-[0.12em]">
                    ...
                    <div className="mt-1 text-[10.5px] text-[color:var(--color-muted)]/60">
        ...
        {!selected ? (
          ...
          <div className="rounded-2xl border border-[color:var(--color-foreground)]/10 bg-[color:var(--color-surface)] p-6 space-y-5">
            <div>
              ...
              <p className="text-[12.5px] text-[color:var(--color-muted)]">slug · {selected.slug} · commission {selected.commissionPct}%</p>
            </div>
            ...
            <div className="pt-3 border-t border-[color:var(--color-foreground)]/8 grid grid-cols-2 gap-3 text-[12.5px]">
            ...
            <div className="pt-3 border-t border-[color:var(--color-foreground)]/8">
              <div className="text-[10.5px] uppercase tracking-[0.14em] text-[color:var(--color-muted)]/65 mb-2">Fulfilment</div>
              ...
              {selected.supportsSelfDelivery && selected.selfDeliveryFeeInr != null && (
                <p className="mt-1 text-[11.5px] text-[color:var(--color-muted)]/70">Self-delivery fee · ₹{selected.selfDeliveryFeeInr}</p>
              )}
            </div>

            <div className="pt-3 border-t border-[color:var(--color-foreground)]/8">
              <div className="text-[10.5px] uppercase tracking-[0.14em] text-[color:var(--color-muted)]/65 mb-2">Wholesale</div>
              <div className="space-y-2">
                <label className="flex items-center gap-2 text-[13px] cursor-pointer">
                  <input
                    type="checkbox"
                ...
                <label className="flex items-center gap-2 text-[13px]">
                  <span className="w-[140px] text-[color:var(--color-muted)]">Min order (₹)</span>
                  <input
                    type="number"
                    ...
                    className="w-32 rounded border border-[color:var(--color-foreground)]/15 px-2 py-1 text-[13px] outline-none focus:border-[color:var(--color-primary)]"
                  />
                </label>
              </div>
            </div>
            ...
            {selected.approvalNote && (
              <div className="rounded-xl bg-[color:var(--color-terracotta)]/8 border border-[color:var(--color-terracotta)]/20 px-4 py-3 text-[12.5px]">
                <span className="text-[color:var(--color-muted)]/70">Last note:</span> {selected.approvalNote}
              </div>
            )}

            {selected.approvalStatus !== 'APPROVED' && (
              <label className="block">
                <span className="text-[11px] uppercase tracking-[0.14em] text-[color:var(--color-muted)]/75">Note (sent to vendor on reject / suspend)</span>
                <textarea rows={2} value={note} onChange={(e) => setNote(e.target.value)} className="mt-1 w-full rounded-xl border border-[color:var(--color-foreground)]/12 bg-[color:var(--color-surface)] px-3 py-2 text-[13.5px] outline-none focus:border-[color:var(--color-primary)]" />
              </label>
            )}
